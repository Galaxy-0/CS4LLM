...
Layer 1 的详细知识树已经双语展开在 [CS_CORE_TREE.md](./CS_CORE_TREE.md)，术语索引见 [CS_CORE_BILINGUAL_GLOSSARY.md](./CS_CORE_BILINGUAL_GLOSSARY.md)。它是后续索引，不改变当前第一阶段仍然先补 Layer 0 的路线。
